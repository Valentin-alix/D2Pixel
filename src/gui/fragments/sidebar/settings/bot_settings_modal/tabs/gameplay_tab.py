...
class GameplayTab(QWidget):
    ...
    def _init_spell_configs(self) -> None:
        ...
        columns: list[ColumnInfo] = [
            ...
            ColumnInfo(name="Index", search_type=None),
            ColumnInfo(name="Élément", search_type=None),
            ColumnInfo(name="Désenchante", search_type=None),
            ColumnInfo(name="Boost", search_type=None),
            ColumnInfo(name="Soigne", search_type=None),
            ColumnInfo(name="Pour un enemi", search_type=None),
            ColumnInfo(name="PA", search_type=None),
            ColumnInfo(name="Max par tour", search_type=None),
            ColumnInfo(name="Portée min", search_type=None),
            ColumnInfo(name="Portée", search_type=None),
            ColumnInfo(name="Durée de boost", search_type=None),
            ColumnInfo(name="Portée Boostable", search_type=None),
            ColumnInfo(name="LVL", search_type=None),
