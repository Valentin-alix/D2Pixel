...
class PyPageIterator:
    ...
    def SetBoundingBoxComponents(
        self, include_upper_dots: bool, include_lower_dots: bool
    ):
    ...
    def BoundingBoxInternal(self, level: RIL) -> typing.Tuple[int, int, int, int]:
    ...
    def BlockPolygon(self) -> typing.List[typing.Tuple[int, int]]:
    ...
    def GetImage(
        self, level: RIL, padding: int, original_image: PIL.Image
    ) -> typing.Tuple[PIL.Image, int, int]:
    ...
    def Orientation(
        self,
    ) -> typing.Tuple[Orientation, WritingDirection, TextlineOrder, float]:
    ...
    def ParagraphInfo(self) -> typing.Tuple[Justification, bool, bool, int]:
...
class PyLTRResultIterator(PyPageIterator):
    ...
    def RowAttributes(self) -> typing.Dict[str, float]:
        """Return row_height, descenders and ascenders in a dict"""
        ...

    def WordFontAttributes(self) -> typing.Dict:
...
class PyResultIterator(PyLTRResultIterator):
    ...
    def GetBestLSTMSymbolChoices(self) -> typing.List[typing.Any]:
...
class PyTessBaseAPI:
    ...
    def __enter__(self) -> PyTessBaseAPI:
        """
        Entrez dans le contexte du gestionnaire.

        Returns:
            L'objet Tesseract OCR lui-même.
        """
        ...
    ...
    def __exit__(
        ...
        """
        Quittez le contexte du gestionnaire.

        Args:
            exc_type: Type d'exception (le cas échéant).
            exc_val: Valeur d'exception (le cas échéant).
            exc_tb: Traceback d'exception (le cas échéant).
        """
        ...
    ...
    @staticmethod
    async def ClearPersistentCache(): ...
    ...
    def Init(self, path: str = ..., lang: str = ..., oem: OEM = OEM.DEFAULT):
    ...
    def GetInitLanguagesAsString(self) -> str:
    ...
    def GetLoadedLanguages(self) -> typing.List[str]:
    ...
    def GetAvailableLanguages(self) -> typing.List[str]:
        """Return list of available languages in the init data path"""
        ...

    def InitForAnalysePage(self) -> None:
    ...
    def GetRegions(self) -> typing.List[typing.Tuple[PIL.Image, typing.Dict]]:
    ...
    def GetTextlines(
        ...
        blockids: bool = True,
        paraids: bool = False,
    ) -> typing.List[typing.Tuple[PIL.Image, typing.Dict, int, int]]:
    ...
    def GetStrips(
        self, blockids: bool = True
    ) -> typing.List[typing.Tuple[PIL.Image, typing.Dict, int]]:
    ...
    def GetWords(self) -> typing.List[typing.Tuple[PIL.Image, typing.Dict]]:
    ...
    def GetConnectedComponents(
        self,
    ) -> typing.List[typing.Tuple[PIL.Image, typing.Dict]]:
    ...
    def ProcessPages(
        self, outputbase: str, filename: str, retry_config: str = None, timeout: int = 0
    ) -> bool:
    ...
    def GetBestLSTMSymbolChoices(self) -> typing.List:
    ...
    def DetectOrientationScript(self) -> typing.Dict:
    ...
    def AllWordConfidences(self) -> typing.List[int]:
    ...
    def AllWords(self) -> typing.List[str]:
    ...
    def MapWordConfidences(self) -> typing.List[typing.Tuple[str, int]]:
    ...
    def GetTextDirection(self) -> typing.Tuple[int, float]:
        """Get text direction.
...
def image_to_text(
    image: PIL.Image, lang=..., psm: PSM = PSM.AUTO, path=..., oem: OEM = OEM.DEFAULT
) -> str:
...
def file_to_text(
    filename: str, lang=..., psm: PSM = PSM.AUTO, path=..., oem: OEM = OEM.DEFAULT
) -> str:
...
def get_languages(path=...) -> typing.Tuple[str, typing.List[str]]:
